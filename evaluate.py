...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=Path, default='/opt/data/private/project/weather-gen_9.27_domain/logs/diffusion/kitti_360/spherical-1024/finetune_newmask/models/diffusion_0000250000.pth')
